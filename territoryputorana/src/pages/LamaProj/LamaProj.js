...
const LamaProj = () => {
  ...
  return (
    <main className = 'lama-proj'>
        ...
        <div className = "tp-about__container">
            <div className='tp-about'>
                ...
                <div className = "tp-about__hit-container">
                  <InfoFrame description = {"Мы сформировали команду из увлеченных своим делом активистов «Территории Путорана», специалистов заповедника, волонтеров для уборки и вывоза мусора с заповедной зоны. Грантовая поддержка и привлечение спонсоров позволяет нам обеспечивать команду проекта необходимой техникой и материалами"} />
                </div>
            </div>
        </div>
      ...
      <RequestBlockProjects bgImage = {'./img/lamaproj/lamaproj_req.jpg'} h2Text = {"Стать волонтером или партнером"} h3Text = {"Оставьте заявку и мы обязательно Вам ответим"}/>
